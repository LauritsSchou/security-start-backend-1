...
public class RecipeService {
    ...
    public RecipeDto addRecipe(RecipeDto request, String userName) {
        ...
        dat3.recipe.entity.Category category = categoryRepository.findByName(request.getCategory()).
    ...
    private void updateRecipe(Recipe original, RecipeDto r, dat3.recipe.entity.Category category) {
